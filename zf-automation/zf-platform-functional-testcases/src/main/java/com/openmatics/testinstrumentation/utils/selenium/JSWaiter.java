...
public class JSWaiter {
    ...
    public static void waitForAngularLoad() {
        ...
        String angularReadyScript = "return angular.element(document).injector().get('$net').pendingRequests.length === 0";
    ...
    public static void waitUntilAngularFinishHttpCalls(int timeOutInSeconds) {
        final String javaScriptToLoadAngular =
                "var injector = window.angular.element('body').injector();" +
                        "var $net = injector.get('$net');" +
                        "return ($net.pendingRequests.length === 0)";
        ...
        WebDriverWait wait = new WebDriverWait(jsWaitDriver, timeOutInSeconds);
